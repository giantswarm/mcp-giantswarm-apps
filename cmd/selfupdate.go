...
const (
	githubRepoSlug = "giantswarm/mcp-giantswarm-apps" // GitHub repository path
)
...
func newSelfUpdateCmd() *cobra.Command {
	return &cobra.Command{
		Use:   "self-update",
		Short: "Update mcp-giantswarm-apps to the latest version",
		Long: `Checks for the latest release of mcp-giantswarm-apps on GitHub and 
